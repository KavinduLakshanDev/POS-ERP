...
class PurchaseOrderReportPermissionTest extends TestCase
{
    use RefreshDatabase;

    public function test_guest_cannot_view()
    {
        $resp = $this->get('/reports/purchase-orders');
    ...
    public function test_user_with_permission_can_view()
    {
        ...
        $this->actingAs($user);
        $this->get('/reports/purchase-orders')->assertStatus(200);
        // pdf route should also be guarded
        $this->get('/reports/purchase-orders/pdf?from_date=2020-01-01&to_date=2020-01-02')->assertStatus(302);
    }
}
