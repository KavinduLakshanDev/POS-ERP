...
//     },
//     {
//         title: t('Petty Cash Category Management'),
//         href: '#',
//     },
// ];
...
// export default function PettyCashCategoryIndex({ categories, filters }: Props) {
...
//             router.patch(`/admin/petty-cash-categories/${toggleModal.category.id}/toggle-status`, {}, {
//                 onSuccess: () => {
...
//             router.delete(`/admin/petty-cash-categories/${deleteModal.category.id}`, {
//                 onSuccess: () => {
...
//             <Head title={t('Petty Cash Category Management')} />
...
//                                         {t('Petty Cash Category Management')}
//                                     </h1>
//                                     <p className="text-xs text-white/80">
//                                         {t("Manage your organization's petty cash categories")}
//                                     </p>
//                                 </div>
//                             </div>
//                             <Link
//                                 href="/admin/petty-cash-categories/create"
...
//                                             {t('Petty Cash Categories List')}
//                                         </h3>
//                                         <p className="text-white/80 text-xs mt-0.5">
//                                             {t('View and manage all petty cash categories')}
//                                         </p>
//                                     </div>
//                                 </div>
//                             </div>
...
//                                                 <h3 className="mt-2 text-sm font-medium text-slate-900">{t('No petty cash categories')}</h3>
...
//                                                         <Link
//                                                             href={`/admin/petty-cash-categories/${category.id}/edit`}
...
//                             <p className="text-xs text-gray-500">© VISMASS {t('Petty Cash Category Management')} • v1.0.0</p>
//                         </div>
//                     </div>
//                 </footer>
//             </div>
