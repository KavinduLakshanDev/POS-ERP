...
//     const { data, setData, processing, errors, reset } = useForm<CategoryFormData>({
//         name: '',
//         description: '',
//         status: 'active',
//     });
...
//         router.post('/admin/petty-cash-categories', data, {
//             onSuccess: () => {
//                 reset();
//             },
//         });
...
//                                 <button
//                                     onClick={() => router.visit('/admin/petty-cash-categories')}
...
//                                         {t('New Petty Cash Category')}
//                                     </h1>
//                                     <p className="text-xs text-white/80">
//                                         {t('Add a new petty cash category to your organization')}
//                                     </p>
//                                 </div>
//                             </div>
//                         </div>
...
//                                                     rows={4}
//                                                     className="block border w-full rounded-xl border-slate-200 focus:border-vismass-blue focus:ring-vismass-blue/20 px-4 py-3"
//                                                     placeholder={t('Short note about this petty cash category')}
//                                                 />
//                                                 {errors.description && (
//                                                     <div className="mt-2 text-sm text-red-600">
//                                                         {errors.description}
