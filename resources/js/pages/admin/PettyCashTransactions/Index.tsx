...
// import ReimbursementDialog from '@/pages/admin/PettyCashTransactions/CreateReimbursement';
// import UsageDialog from '@/pages/admin/PettyCashTransactions/CreateUsage';
...
// export default function PettyCashTransactionIndex({ next_transaction_no, transactions, stats, by_category, categories, filters }: Props) {
...
//             router.delete(`/admin/petty-cash-transactions/${deleteModal.transaction.id}`, {
//                 onSuccess: () => {
...
//             <Head title={t('Petty Cash Ledger')} />
...
//                                     </div>
//                                     <div className="text-sm text-slate-600">Petty Cash Ledger Report</div>
...
//                                                             {tx.type === 'usage' && tx.category_id === cat.id ? (
//                                                                 <span className="font-semibold text-red-600">{money(tx.amount)}</span>
//                                                             ) : (
//                                                                 <span className="text-slate-300">-</span>
//                                                             )}
...
//                             <p className="text-xs text-gray-500">© VISMASS {t('Petty Cash Management')} • v1.0.0</p>
//                         </div>
//                     </div>
//                 </footer>
//             </div>
...
//                                 <>
//                                     {t('Are you sure you want to delete this petty cash entry')} "{particulars(deleteModal.transaction)}"?{' '}
