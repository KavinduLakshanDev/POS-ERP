...
//                     </DialogTitle>
//                     <DialogDescription>
//                         {t('Record petty cash spent against a category')}
//                     </DialogDescription>
//                 </DialogHeader>
...
//                             onChange={(e) => setData('category_id', parseInt(e.target.value, 10))}
...
//                         </select>
//                         {errors.category_id && (
//                             <div className="text-sm text-red-600">{errors.category_id}</div>
//                         )}
//                     </div>
