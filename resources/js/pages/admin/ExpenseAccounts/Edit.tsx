...
// export default function Edit({ expenseAccount, flash }: Props) {
...
//         router.put(`/admin/expense-accounts/${expenseAccount.id}`, data as any);
//     };

//     return (
//         <AppLayout breadcrumbs={breadcrumbs}>
//             <Head title={t('Edit Expense Account')} />
...
//                                         {t('Edit Expense Account')}
//                                     </h1>
//                                     <p className="text-xs text-white/80">
//                                         {t('Update Expense Account information')}
//                                     </p>
//                                 </div>
//                             </div>
//                         </div>
...
//                                                 <span>{t('Update Expense Account')}</span>
//                                             </div>
//                                         )}
//                                     </Button>
//                                 </div>
