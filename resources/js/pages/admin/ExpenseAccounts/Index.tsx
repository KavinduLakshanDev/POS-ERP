...
// export default function expenseAccountIndex({ expenseAccounts, filters, flash }: Props) {
//     const { hasPermission } = usePermission();
//     const [searchTerm, setSearchTerm] = useState(filters.search || '');
//     const [selectedStatus, setSelectedStatus] = useState(filters.status || '');
//     const [toggleModal, setToggleModal] = useState<{ show: boolean; account: expenseAccount | null }>({
//         show: false,
//         account: null,
//     });
...
//     const handleToggleStatus = (account: expenseAccount) => {
...
//             router.patch(`/admin/expense-accounts/${toggleModal.account.id}/toggle-status`, {}, {
//                 onSuccess: () => {
...
//     const totalAccounts = expenseAccounts.data.length;
//     const activeAccounts = expenseAccounts.data.filter(account => account.status).length;
//     const inactiveAccounts = expenseAccounts.data.filter(account => !account.status).length;
...
//                                         {t('Manage your organization\'s Expense Accounts')}
//                                     </p>
//                                 </div>
//                             </div>
//                             <Link
//                                 href="/admin/expense-accounts/create"
...
//                                             {t('Expense Accounts List')}
//                                         </h3>
//                                         <p className="text-white/80 text-xs mt-0.5">
//                                             {t('View and manage all Expense Accounts')}
//                                         </p>
//                                     </div>
//                                 </div>
//                             </div>
...
//                                                 <input
//                                                     type="text"
//                                                     placeholder={t('Search Expense Accounts...')}
//                                                     value={searchTerm}
...
//                                         {expenseAccounts.data.length === 0 ? (
//                                             <div className="rounded-2xl border border-slate-200 bg-white p-6 text-center">
//                                                 <Building2 className="mx-auto h-12 w-12 text-slate-400" />
//                                                 <h3 className="mt-2 text-sm font-medium text-slate-900">{t('No Expense Accounts')}</h3>
//                                                 <div className="mt-6">
//                                                     <Link
//                                                         href="/admin/expense-accounts/create"
...
//                                                         </div>
//                                                     </div>
//                                                     <div className="mt-3 grid grid-cols-1 gap-3 text-xs text-slate-600">
//                                                         <div>
...
//                                                         {hasPermission('expense_accounts.edit') && (
//                                                             <Link
//                                                                 href={`/admin/expense-accounts/${account.id}/edit`}
...
//                                                                     Rs. {Number(account.current_balance || 0).toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 })}
//                                                                 </div>
//                                                             </td>
//                                                             <td className="px-4 py-2.5 whitespace-nowrap">
//                                                                 {getStatusBadge(account.status)}
...
//                                                                         <Link
//                                                                             href={`/admin/expense-accounts/${account.id}`}
//                                                                             className="text-vismass-blue hover:text-sky-700"
//                                                                             title={t('View Ledger')}
//                                                                         >
...
//                                     {expenseAccounts.meta && expenseAccounts.meta.last_page > 1 && (
//                                         <div className="bg-white px-4 py-3 border-t border-slate-200 sm:px-6">
//                                             <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
//                                                 <div className="text-sm text-slate-700">
//                                                     {t('Showing')} {expenseAccounts.meta.from} {t('to')} {expenseAccounts.meta.to} {t('of')} {expenseAccounts.meta.total} {t('results')}
//                                                 </div>
//                                                 <div className="flex flex-wrap gap-1">
//                                                     {expenseAccounts.links.map((link, index) => (
//                                                         <Link
//                                                             key={index}
//                                                             href={link.url || '#'}
...
//                             className={`bg-vismass-blue text-white hover:bg-vismass-blue/90 ${toggleProcessing ? 'opacity-50 cursor-not-allowed' : ''}`}
