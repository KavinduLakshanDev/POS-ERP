...
<head>
    <meta charset="utf-8">
    <title>Customer Outstandings Report</title>
    <style>
        body {
...
<body>
    ...
    <div class="header">
        ...
        <div class="report-title">Customer Outstandings Report</div>
        <div style="font-size: 10px; margin-top: 5px;">
            Generated on: {{ date('d/m/Y H:i:s', strtotime($date)) }}
        </div>
    </div>
            ...
            <tr>
                <td>
                    <div class="summary-card">
                        ...
                        <div class="summary-value">{{ $reportData['summary']['total_customers'] }}</div>
                    </div>
                </td>
                <td>
                    <div class="summary-card">
                        <div class="summary-label">Total Outstanding</div>
                        <div class="summary-value">Rs {{ number_format($reportData['summary']['total_outstanding'], 2) }}</div>
                    </div>
                </td>
            </tr>
        </table>
    ...
    <table>
        <thead>
            <tr>
                ...
                <th class="text-right">Outstanding Balance (Rs)</th>
            </tr>
        </thead>
        <tbody>
        ...
        <tfoot>
            <tr style="background-color: #e2e8f0; font-weight: bold;">
                ...
                <td class="text-right">Rs {{ number_format($reportData['summary']['total_outstanding'], 2) }}</td>
            </tr>
        </tfoot>
    </table>
    ...
    <!-- Footer -->
    <div class="footer">
        <div>{{ $companyName }} - Customer Outstandings Report</div>
